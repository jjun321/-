...
public class CategoryActivity extends AppCompatActivity {
    ...
    private List<CategoryElement> getCategoryList(String categoryType) {
        ...
        // 외국어 카테고리
            ...
            elements.add(new CategoryElement("해커스", "https://www.hackers.com/", R.drawable.ic_hackers));
            elements.add(new CategoryElement("YBM 어학원", "https://www.ybmedu.com/",R.drawable.ic_ybm));
            elements.add(new CategoryElement("파고다", "https://www.pagoda21.com/",R.drawable.ic_pagoda));
            elements.add(new CategoryElement("월스트리트 잉글리쉬", "https://www.wallstreetenglish.co.kr/",R.drawable.ic_wse));
        }
        // 프로그래밍 카테고리
        else if ("programming".equals(categoryType)) {
            elements.add(new CategoryElement("인프런", "https://www.inflearn.com/", R.drawable.ic_inflearn));
            elements.add(new CategoryElement("생활코딩", "https://opentutorials.org/", R.drawable.ic_lifecoding));
            elements.add(new CategoryElement("패스트캠퍼스", "https://www.fastcampus.co.kr/", R.drawable.ic_fastcampus));
            elements.add(new CategoryElement("코드스테이츠", "https://www.codestates.com/", R.drawable.ic_codestates));
        }
        // 필수 자격증 카테고리
